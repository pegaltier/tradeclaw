...
const en: Translations = {
  ...
  hero: {
    ...
    ctaPrimary: "Deploy free in minutes",
  ...
  howItWorks: {
    ...
    title: "Deploy in ",
    titleAccent: "minutes",
    subtitle: "MIT-licensed and self-hosted. Bring your own broker keys — no fees to us, ever.",
    steps: [
...
const es: Translations = {
  ...
  hero: {
    ...
    ctaPrimary: "Despliega gratis en minutos",
  ...
  howItWorks: {
    ...
    title: "Despliega en ",
    titleAccent: "minutos",
    subtitle: "Con licencia MIT y autoalojado. Usa tus propias claves de broker — sin cuotas para nosotros, nunca.",
    steps: [
...
const zh: Translations = {
  ...
  howItWorks: {
    badge: "开始使用",
    title: "",
    titleAccent: "几分钟内完成部署",
    subtitle: "MIT 许可、自托管。使用你自己的经纪商密钥 — 永远不向我们付费。",
    steps: [
...
const ms: Translations = {
  ...
  hero: {
    ...
    ctaPrimary: "Pasang percuma dalam beberapa minit",
  ...
  howItWorks: {
    badge: "Mulakan",
    title: "Pasang dalam ",
    titleAccent: "beberapa minit",
    subtitle: "Berlesen MIT dan dihos sendiri. Guna kunci broker anda sendiri — tiada yuran kepada kami, selamanya.",
    steps: [
  ...
  deploy: {
    badge: "Pasang dalam beberapa minit",
...
const ar: Translations = {
  ...
  hero: {
    ...
    ctaPrimary: "انشر مجاناً في دقائق",
  ...
  howItWorks: {
    ...
    title: "النشر في ",
    titleAccent: "دقائق",
    subtitle: "مرخّص بترخيص MIT ومستضاف ذاتيًا. استخدم مفاتيح وسيطك الخاصة — لا رسوم لنا أبدًا.",
    steps: [
